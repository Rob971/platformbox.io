...
[`platformbox-idp/docs/architecture/architecture.md`](https://gitlab.com/platform-box-group/platformbox-idp/-/blob/main/docs/architecture/architecture.md)
(single source of truth, rendered client-side) — no local copy here.
