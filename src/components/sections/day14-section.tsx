...
export function Day14Section() {
  return (
    <section id="day-14" className="border-t border-white/10">
      <div className="mx-auto max-w-6xl px-6 py-20 md:py-28">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
                ...
                {day14.steps.map((step, i) => {
                  ...
                  return (
                    <Fragment key={step}>
                      ...
                      <li className="flex items-center gap-3 rounded-lg border border-white/10 bg-zinc-950/40 px-4 py-3">
                        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md border border-white/10 bg-zinc-950 text-accent">
          ...
          <FadeIn delay={0.1}>
            <div className="flex h-full flex-col rounded-xl border border-white/10 bg-white/[0.03] p-6 sm:p-8">
              <p className="mb-5 text-sm font-semibold text-white">On Day 14, your team can:</p>
